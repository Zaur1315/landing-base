    ...
    <main class="site legal-site">
        ...
        <section class="legal-page">
            <div class="container legal-container">
                ...
                <p>
                    {{ config('company.legal_name') }} respects your privacy. This Privacy Policy explains how we
                    collect,
                ...
                <p>
                    ...
                    message content, IP address, browser information, and other technical information related to your
                    visit.
                </p>
                ...
                <p>
                    Our website may use cookies, analytics tools, Meta Pixel, or similar technologies to understand
                    website
