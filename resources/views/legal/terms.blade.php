...
@section('content')
    <main class="legal-page">
        <div class="container narrow">
            ...
            <h2>Website Use</h2>
            <p>
                This website is provided for general informational purposes. By using this website, you agree to use it
                lawfully and not attempt to interfere with its operation.
            </p>

            <h2>Equipment Information</h2>
            <p>
                Any equipment descriptions, availability, pricing, or related information provided through this website
                may change without notice. Website content does not guarantee availability or create a binding offer.
            </p>
